...
class DeformDataset(Dataset):
    def __init__(self, data_dir, cage_res=(12,12,12)):
...
def train_and_infer(args):
    ...
    # --- dataset & adjacency ---
    ds = DeformDataset(args.data_dir, cage_res=tuple(args.cage_res))
...
if __name__=='__main__':
    ...
    p.add_argument('--data_dir',type=str,default='data/scene2')
